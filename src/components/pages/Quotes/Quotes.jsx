import { default as Container } from "./QuotesContainer";
import { default as TableForm } from "./QuotesForm";
...
import { useCurrency, useDate } from "../../../composables/useFormat";
              ...
              return (
                ...
                >
                  {columns.map((column, columnIndex) => {
                    ...
                    if (column.id === "date") {
                      value = useDate(row[column.id]);
                    }
                    if (column.id === "price") {
                      value = useCurrency(row[column.id]);
                    }
                    return (
